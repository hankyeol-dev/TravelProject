...
struct MagazineInfo {
    static let magazine: [Magazine] = [
        ...
        Magazine( id: 12, title: "핑크빛 바다가 펼쳐지는 환상의 섬, 롬복", subtitle: "잊히지 않는 TV속 그곳!", photo_image: "https://plus.unsplash.com/premium_photo-1671595277425-601080e369db?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8JTA4JUVEJTk1JTkxJUVEJTgxJUFDJTIwJUVCJUIwJTk0JUVCJThCJUE0fGVufDB8fDB8fHww", date: "240101", link: "https://triple.guide/content/articles/8c4cded5-ff1e-4898-b884-c7b9f84fd5d8"),
        Magazine( id: 13, title: "여행 고수가 알려주는 새벽 비행기 이용 꿀팁", subtitle: "이제 공항에서 시간 때울 걱정 끝!", photo_image: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8JUVCJUI5JTg0JUVEJTk2JTg5JUVBJUI4JUIwfGVufDB8fDB8fHww", date: "240105", link: "https://triple.guide/content/articles/791578f3-95d7-4300-a51f-6dff48db5d55"),
        
    ]
    
    static func getMagazineById(_ id: Int) -> [Magazine] {
        return MagazineInfo.magazine.filter {
            item in return item.id == id
        }
    }
}
